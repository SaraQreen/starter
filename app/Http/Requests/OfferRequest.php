...
class OfferRequest extends FormRequest
{
    ...
    public function messages(){
        return [
            'name_ar.required'=>__('messages.offer name required'),   //trans()
            'name_en.required'=>__('messages.offer name required'),
            'name_ar.unique'=>__('messages.offer name must be uniqe'),
            'name_en.unique'=>__('messages.offer name must be uniqe'),
